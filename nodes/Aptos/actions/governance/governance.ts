...
export const governanceOperations: INodeProperties[] = [
  {
    ...
    options: [
      { name: 'Get', value: 'get', action: 'Get governance' },
      { name: 'List', value: 'list', action: 'List governances' },
    ],
    default: 'get',
  },
];
...
export async function executeGovernanceOperation(
  ...
  return { resource: 'governance', operation, address, note: 'Operation placeholder' };
}
